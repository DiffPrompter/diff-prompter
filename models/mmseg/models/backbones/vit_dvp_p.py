...
class VisionTransformerDVPParallel(nn.Module):
    ...
    def __init__(self, model_name='vit_large_patch16_384', img_size=384, patch_size=16, in_chans=3, embed_dim=1024, depth=24,
        ...
        super(VisionTransformerDVPParallel, self).__init__()
        ...
        self.gdip_imgs = None
        self.gdip_gates = None
        self.gdip_emb = None
        # self.gdip_vpdt_emb = None
    ...
    def forward(self, x):
        ...
        handcrafted_feature,emb, gdip_imgs, gdip_gates = self.prompt_generator.init_handcrafted(inp)
        prompt = self.prompt_generator.get_prompt(handcrafted_feature, embedding_feature)
        
        self.gdip_imgs = [gdip_imgs]
        self.gdip_gates = gdip_gates
        self.gdip_emb = emb
...
class PromptGenerator(nn.Module):
    def __init__(self, scale_factor, prompt_type, embed_dim, tuning_stage, depth, input_type,
        ...
        # self.gdip_vpt = nn.Parameter(torch.zeros(
        #     1,self.depth,self.num_patches, self.embed_dim))
        # self.gdip_proj = nn.Linear(self.embed_dim*2,self.embed_dim)
    ...
    def init_handcrafted(self, x):
        ...
        x,emb, gate, gdip_dict = self.gdip(x)
        # return self.prompt_generator(x), emb, x, gate
        return self.prompt_generator(x), emb, gdip_dict, gate
